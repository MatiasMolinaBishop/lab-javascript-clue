...
const weaponsArray = [
    ...
    {
        name:"candlestick", weight:12
    },
    {
        name:"dumbbell", weight:30
    },
    {
        name:"poison", weight:22
    },
    {
        name:"axe", weight:15
    },
...
//select randomly a card / element from object / car stack
//The function should expect an array as an argument, and should return a random element from the array.
function selectRandom(cardsDeck) {
    randomCard = cardsDeck[Math.floor((Math.random()*cardsDeck.length))];
    return randomCard;
}
